...
A Helm chart to deploy Tornjak UI (frontend) component
...
|-----|------|---------|-------------|
| apiServerURL | string | `"http://localhost:10000/"` | URL of the Tornjak APIs (backend). The default value is used when both deployed in the same, local cluster. |
