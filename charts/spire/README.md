...
| spire-server.dataStore.dbSecret | object | `{"key":"DBPW","name":""}` | The secret should reside in the same namespace as the spire server |
| spire-server.dataStore.dbSecret.key | string | `"DBPW"` | The key of the secret object whose value is the dataStore password |
| spire-server.dataStore.dbSecret.name | string | `""` | The name of the secret object |
