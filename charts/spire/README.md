...
You can just helm install the chart. It should work out of the box for basic testing.

## Deployment - Production

The spire chart is shipped with examples and production profiles to make it significantly easier to produce a production ready deployment that works with the version you are deploying.
